...
model_path = resource_path("en_core_web_sm/en_core_web_sm-3.8.0")
...
def extract_entities(text, lines=None):
    ...
    if lines:
        ...
        designation_keywords = [
            ...
            "lead", "analyst", "developer", "executive","associate","master","owner","scientist","dr"
        ]
        ...
        address_keywords = [
            ...
            "near", "opposite", "india",
            "tamilnadu", "coimbatore","block","pincode"
            "pvt", "ltd"
        ]
